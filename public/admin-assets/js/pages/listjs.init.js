...
var table = document.getElementById("customerTable"), tr = table.getElementsByTagName("tr"),
    trlist = table.querySelectorAll(".list tr"), count = Number(isValue.replace(/[^0-9]/g, "")) + 1;
addBtn.addEventListener("click", function (e) {
    ...
    document.getElementById("exampleModalLabel").innerHTML = "Edit Customer", customerList.get({id: idField.value}).forEach(function (e) {
...
function refreshCallbacks() {
    removeBtns.forEach(function (e) {
        e.addEventListener("click", function (e) {
            e.target.closest("tr").children[1].innerText, itemId = e.target.closest("tr").children[1].innerText, customerList.get({id: itemId}).forEach(function (e) {
