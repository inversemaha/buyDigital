...
<head>
    ...
    <!-- quill css -->
    <link href="/admin-assets/libs/quill/quill.core.css" rel="stylesheet" type="text/css"/>
    <link href="/admin-assets/libs/quill/quill.bubble.css" rel="stylesheet" type="text/css"/>
    <link href="/admin-assets/libs/quill/quill.snow.css" rel="stylesheet" type="text/css"/>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarAdvanceUI" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="sidebarAdvanceUI">
                            <i class="mdi mdi-layers-triple-outline"></i> <span
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse"
                           role="button" aria-expanded="false" aria-controls="sidebarMultilevel">
                            <i class="mdi mdi-share-variant-outline"></i> <span
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- end page title -->
                <form method="get" action="/lol/save">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>ckeditor-classic</code> class to set ckeditor
                                        classic editor.</p>
                                    <textarea name="ck" class="ckeditor-classic"></textarea>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea name="snow" class="snow-editor" style="height: 300px;"></textarea>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div name="buble" class="bubble-editor" style="height: 300px;">
                                    <h3><span class="ql-size-large">Hello World!</span></h3>
                                    <p><br></p>
                                    <h3>This is an simple editable area.</h3>
                                    <p><br></p>
...
<!-- ckeditor -->
<script src="/admin-assets/libs/%40ckeditor/ckeditor5-build-classic/build/ckeditor.js"></script>
