        ...
        <div class="container">
            <div class="breadcrumb">
                <ul class="list-unstyled">
                    <li><a href="/">Home</a></li>
                    <li><a href="/find-out-more/offline-activation">ATL/ BTL Support or Offline activation</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6" data-sal="slide-right" data-sal-duration="800">
                    <div class="case-study-featured">
                        <div class="section-heading heading-left">
                            ...
                            <h2 class="title">ATL/ BTL Support or Offline activation</h2>
                            <p>If you are searching for ATL, BTL or Offline Activation besides digital marketing for your brand
                                you may make the choice with us.<br>
                                For more information,<br> please contact, <a href="mailto:sales@buydigitalbd.com">sales@buydigitalbd.com/</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-6 d-none d-lg-block" data-sal="slide-left" data-sal-duration="800">
                    <div class="case-study-featured-thumb">
                        <img src="/assets/media/services/ATL-BTL-ACTIVATION.png" alt="ATL-BTL-ACTIVATION">
                    </div>
                </div>
            </div>
        </div>
