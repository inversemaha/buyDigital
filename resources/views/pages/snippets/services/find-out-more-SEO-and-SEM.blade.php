        ...
        <div class="container">
            <div class="breadcrumb">
                <ul class="list-unstyled">
                    <li><a href="/">Home</a></li>
                    <li><a href="/find-out-more/SEO-and-SEM">SEO and SEM</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="case-study-featured">
                        <div class="section-heading heading-left">
                            ...
                            <p>SEO referred to as Search Engine Optimization is the procedure of acquiring traffic to your
                                ...
                                Optimization is for targeted ads that you pay for. Both of those have a not unusual place goal to
                                accumulate extra visitors so one can in the end raise sales generation. A steady search engine
                                marketing attempt will bring about a devoted and lasting purchaser base whilst the utility of
                                SEM affords a right-way upward push in sale conversions with paid ads.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-6 d-none d-lg-block" data-sal="slide-left" data-sal-duration="800">
                    <div class="case-study-featured-thumb">
                        <img src="/assets/media/services/SEO-and-SEM.png" alt="SEO-and-SEM">
                    </div>
                </div>
            </div>
        </div>
