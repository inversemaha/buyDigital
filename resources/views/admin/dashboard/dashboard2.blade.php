                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    ...
                                                    <div class="avatar-group-item">
                                                        <a href="javascript: void(0);" class="d-inline-block">
                                                            <img src="/admin-assets/images/users/avatar-6.jpg" alt=""
                                                                 class="rounded-circle avatar-xxs">
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    <div class="avatar-group-item">
                                                        <a href="javascript: void(0);" class="d-inline-block">
                                                            <img src="/admin-assets/images/users/avatar-7.jpg" alt=""
                                                                 class="rounded-circle avatar-xxs">
                                                        </a>
                                                    </div>
                                                    <div class="avatar-group-item">
                                                        ...
                                                        <div class="ctext-wrap">
                                                            <div class="message-img mb-0">
                                                                <div class="message-img-list">
                                                                    <div>
                                                                        <a class="popup-img d-inline-block"
                                                                           href="/admin-assets/images/small/img-1.jpg">
                                                                            <img src="/admin-assets/images/small/img-1.jpg"
                                                                ...
                                                                <div class="message-img-list">
                                                                    <div>
                                                                        <a class="popup-img d-inline-block"
                                                                           href="/admin-assets/images/small/img-2.jpg">
                                                                            <img src="/admin-assets/images/small/img-2.jpg"
                                                                                 alt="" class="rounded border">
                                                                        </a>
                                                                    </div>
                                                                    <div class="message-img-link">
...
<!-- projects js -->
<script src="/admin-assets/js/pages/dashboard-projects.init.js"></script>
